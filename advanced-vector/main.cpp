...
void Test6() {
    ...
    }
    {
        ...
        // std::cout << "Obj::num_copied " << Obj::num_copied <<" - "<< 0 << std::endl;
        // std::cout << "Obj::num_default_constructed " << Obj::num_default_constructed <<" - "<< SIZE << std::endl;
        // std::cout << "Obj::num_constructed_with_id_and_name " << Obj::num_constructed_with_id_and_name <<" - "<< 1 << std::endl;
        // std::cout << "Obj::num_moved " << Obj::num_moved <<" - "<< old_num_moved + 1 << std::endl;
        // std::cout << "Obj::num_move_assigned " << Obj::num_move_assigned <<" - "<< SIZE - 3 << std::endl;
        // std::cout << "Obj::num_assigned " << Obj::num_assigned <<" - "<< 0 << std::endl;
        assert(Obj::num_copied == 0);
        assert(Obj::num_default_constructed == SIZE);
        assert(Obj::num_constructed_with_id_and_name == 1);
...
// void PrintVector (const Vector<int>& temp) {
